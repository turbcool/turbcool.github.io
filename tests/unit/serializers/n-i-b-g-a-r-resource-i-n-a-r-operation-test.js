...
moduleForModel('n-i-b-g-a-r-resource-i-n-a-r-operation', 'Unit | Serializer | n-i-b-g-a-r-resource-i-n-a-r-operation', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:n-i-b-g-a-r-resource-i-n-a-r-operation',
    'transform:file',
    'transform:decimal',
    'transform:guid',
